...
vim.api.nvim_set_hl(0, "Statement", { fg = color.blue, bold = false, italic = true })
...
vim.api.nvim_set_hl(0, "Constant", { fg = color.cyan, bold = false })
...
vim.api.nvim_set_hl(0, "Identifier", { fg = color.green, italic = false })
...
vim.api.nvim_set_hl(0, "Function", { fg = color.violet, bold = false })
vim.api.nvim_set_hl(0, "Include", { link = "Function" })
vim.api.nvim_set_hl(0, "Operator", { link = "Function" })

vim.api.nvim_set_hl(0, "Special", { fg = color.yellow, italic = false, bold = false })
