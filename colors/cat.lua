...
vim.api.nvim_set_hl(0, "Normal", { bg = color.base, fg = color.text })
...
vim.api.nvim_set_hl(0, 'Number', { bg = nil, fg = color.red })
...
vim.api.nvim_set_hl(0, "Statement", { fg = color.mauve, bg = nil })
...
vim.api.nvim_set_hl(0, "Keyword", { fg = color.maroon, bg = nil })
