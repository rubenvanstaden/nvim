...
-- Editor
vim.api.nvim_set_hl(0, "LineNr", { bg = nil, fg = color.sumiInk4, bold = false })
...
vim.api.nvim_set_hl(0, "CursorLine", { bg = sumiInk3, fg = nil })
vim.api.nvim_set_hl(0, "CursorLineNr", { bg = nil, fg = color.fujiWhite })
vim.api.nvim_set_hl(0, "Folded", { bg = color.sumiInk4, fg = nil })
