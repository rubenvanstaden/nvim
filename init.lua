...
vim.api.nvim_set_hl(0, "Statement",      { fg = color.nord09 })
vim.api.nvim_set_hl(0, "Structure",      { fg = color.nord09 })
vim.api.nvim_set_hl(0, "StorageClass",   { fg = color.nord09 })
vim.api.nvim_set_hl(0, "Boolean",        { fg = color.nord09 })
vim.api.nvim_set_hl(0, "Constant",       { fg = color.nord07, bold = false })
...
vim.api.nvim_set_hl(0, "Conditional",    { fg = color.nord09, bold = false })
vim.api.nvim_set_hl(0, "Label",          { fg = color.nord09 })
vim.api.nvim_set_hl(0, "PreProc",        { fg = color.nord09 })
...
vim.api.nvim_set_hl(0, "NonText",      { fg = color.nord01 })
...
vim.api.nvim_set_hl(0, "LineNr",       { fg = color.nord03, bold = false })
...
vim.api.nvim_set_hl(0, "ledgerTransactionMetadata", { fg = color.nord03, bold = false })
vim.api.nvim_set_hl(0, "shDerefSimple",             { fg = color.nord16, bold = true })
vim.api.nvim_set_hl(0, "markdownCode",              { fg = color.nord07, bold = false })
