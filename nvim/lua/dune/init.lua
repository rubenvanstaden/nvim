...
local highlights = {
  ...
  { hg = 'Special',        fg = colors.foreground, gui = 'bold'         }, -- any special symbol
  ...
  { hg = 'MatchParen',       fg = colors.blue, gui = 'bold', cterm = 'bold' }, --The character under the cursor or just before it, if it is a paired bracket, and its match.
 ...
 { hg = 'NvimTreeRootFolder', fg = colors.comment_grey },
  ...
  { hg = 'NvimTreeExecFile', fg = colors.foreground, gui = 'bold' },
  -- { hg = 'NvimTreeSpecialFile', fg = colors.foreground, gui = 'bold' },
}
